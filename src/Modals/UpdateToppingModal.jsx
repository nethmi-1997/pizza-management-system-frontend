...
export const UpdateToppingModal = ({ showModal, setShowModal, toppingDetails }) => {
    ...
    useEffect(() => {
        setValues({
            ...values,
            name: toppingDetails.name,
            smallPrice: toppingDetails.smallPrice,
            veg: toppingDetails.veg
        })
    }, [toppingDetails]);
    ...
    const handleSubmit = e => {
        ...
        if(Object.keys(errors).length === 0 && isSubmitting) {
            ToppingService.updateTopping(toppingDetails.id , name, smallPrice, veg)
    .then(
        () => {
            setShowModal(false);
            setSnackbarMessage("Topping updated Successfully");
        ...
        error => {
            const resMessage =
                ...
                error.message ||
                error.toString();
            setSnackbarMessage("ERROR: Unable to update topping. " + resMessage);
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        defaultChecked={toppingDetails.vegan === true ? true : false}
                                        />
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        defaultChecked={toppingDetails.vegan === false ? true : false}
                                        />
                                    </td>
                                    <td className="radioLabel">
